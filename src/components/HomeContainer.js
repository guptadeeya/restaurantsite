    ...
    return (
        <section id='home' className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full'>
            ...
            <div className='py-2 flex-1 flex items-center relative'>
                ...
                <div className='w-full h-full absolute top-0 left-0 lg:px-32 py-4 flex items-center justify-center gap-5 flex-wrap drop-shadow-lg'>
                    {heroData && heroData.map(n => (
                        <div key={n.id} className=' lg:w-190 p-4 bg-cardOverlay backdrop-blur-md rounded-3xl flex flex-col items-center justify-center drop-shadow-lg'>
                            ...
                            <img className='w-20 lg:w-40 -mt-10 lg:-mt-20' src={n.imageSrc} alt="ice-cream" />
