...
const CartItem = ({ item }) => {
    ...
    // below code means that is there is any change in the qty,, get the cart items and update it in the items
    useEffect(() => {
        setItems(cartItems)
    },
        [qty])
    ...
    return (
        <div className='w-full p-1 px-2 rounded-lg bg-cartItem flex items-center gap-2'>
            <img src={item?.imageURL} className='w-2p h-20 max-w-[60px] rounded-full object-contain' alt="cart-item" />
