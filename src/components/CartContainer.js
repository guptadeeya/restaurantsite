            ...
            {cartItems && cartItems.length > 0 ? (
                <div className='w-full h-full bg-cartBg flex flex-col rounded-t-[2rem]'>
                    ...
                    <div className='w-full h-340 md:h-42 px-6 py-10 flex flex-col gap-3 overflow-y-scroll scrollbar-none'>
                        ...
                        {/* cart item */}
                        {
                            // a cart item can be empty but its value will not be 0 as there is empty cart
                    ...
                    <div className='w-full flex-1 bg-cartTotal flex flex-col items-center justify-evenly px-8 py-2 rounded-t-[2rem]'>
                        ...
                        {user ? (
                            ...
                            whileTap={{ scale: 0.8 }}
                            type='button'
                            className='w-full p-2 rounded-full bg-gradient-to-tr from-orange-400 to-orange-600 text-gray-50 text-lg my-2 hover:shadow-lg'>Login to check out</motion.button> 
                        )}
